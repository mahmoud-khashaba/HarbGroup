	...
	<div class="container">				
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="index.html">الرئيسية </a>  <span class="lnr lnr-arrow-left"></span><a href="/projects"> مشاريع</a> <span class="lnr lnr-arrow-left"></span><a href="/projects/{{$project->slug}}">{{$project->title}}</a></p>
			</div>	
		</div>
	</div>
</section>
